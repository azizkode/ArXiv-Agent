...
class EmailSender:
    ...
    def _generate_html(self, papers: List[Dict], query: str, briefing: str, derived_queries: List[str] = None, has_chart: bool = False) -> str:
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h2>🕵️ ArXiv Agent v1.0 Report</h2>
        ...
        html_content += """
                <div class="footer">
                    Generated by ArXiv Agent v1.0 (Powered by GPT) | Personalized Profile Edition
                </div>
            </div>
        </body>
        </html>
...
class ArXivAgent:
    ...
    async def run(self):
        """运行主流程"""
        print("--- ArXiv Agent v1.0 Started (Personalized Profile Edition) ---")
